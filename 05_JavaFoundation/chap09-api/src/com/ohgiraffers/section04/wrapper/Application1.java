...
//        Integer num1 = new Integer(num);
        ...
        /** ValueOf 메소드가 byte 범위의 숫자를 캐싱하여 사용하고 있어,
         * num 값이 10인 경우 true가 나오지만
         * 기본적으로 인스턴스를 비교하는 것은 주소값 비교이므로,
         * num 값이 byte 범위 이상의 숫자의 경우 false가 나온다. */
        ...
        /** 따라서 레퍼 클래스 타입의 인스턴스를 값 비교 하고 싶다면 equals() 메소드를 사용한다. */
