...
public class LectureController {
    ...
    public ModelAndView expression(ModelAndView mv) {
        mv.addObject("member", new MemberDTO("다람쥐", 20, '무', "서울시"));
    ...
    public ModelAndView contidional(ModelAndView mv) {
        mv.addObject("num", 1);
        mv.addObject("str", "바나나");

        List<MemberDTO> memberList = new ArrayList<>();
        memberList.add(new MemberDTO("판다", 10, '여', "서울시 종로구"));
        memberList.add(new MemberDTO("다람쥐", 25, '무', "서울시 서초구"));
        memberList.add(new MemberDTO("원숭이", 40, '남', "서울시 마포구"));
        memberList.add(new MemberDTO("양", 30, '여', "서울시 관악구"));
