...
public class MethodMappingTestController {
    ...
    /** 메소드 방식 지정
     * 요청 URL을 value 속성에 설정, 요청 method를 method 속성에 설정 */
    @RequestMapping(value = "/menu/modify", method = RequestMethod.GET)
    public String modifyMenu(Model model)
    {
        model.addAttribute("message", "GET 방식의 수정용 핸들러 메소드 호출함");
    ...
    {
        model.addAttribute("message", "POST 방식의 수정용 핸들러 메소드 호출함");
    ...
    public String postGetDeleteMenu(Model model)
    {
